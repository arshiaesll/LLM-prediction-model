...
# Enter text generated by Mistral and Gemini
# Links shouldn't look like buttons In line button, Regular text with underline, button below
...
with tab1:
    ...
    st.header("""It's 2050, and you became a history prompt engineering professor. After telling your students how "back in the day" you used to write your own essays, you decide to finally give them an assignment:""", )
    st.header(""" "Prompt Gemini to write about AI revolution in 20's and 30's" """)
    st.header("""You being an expert in the field have obtained your PhD titled "Dialectics of Dialogue: Advancing Prompt Engineering Methodologies with Gemini AI Models", however shortly after your graduation, Mistral AI had a breakthrough and students started using that instead...""")
    st.header("""Seeing your career at danger, I didn't have any choice but to make a tool for you.""")
    ...
    model = Model()
    button = st.button("Predict", on_click=button_func)
    ...
    st.markdown("<h6  style='font-family:Arial; color:white'>This Statistical model has been trained on Gemini-flash-2.0 and Mistral Large 2 (24.11) and it's very model dependant, if you want to try it out you can go to following links and paste the response back:</h1>", unsafe_allow_html=True)
